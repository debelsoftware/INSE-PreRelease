...
function attachToTask(files){
  ...
  for (file of files) {
    ...
    profilePic.src = '../img/file.svg';
    fileElem.href = file.url;
    fileElem.target = '_blank';
    fileDiv.classList.add('file');
    fileDiv.appendChild(profilePic);
    fileDiv.appendChild(name);
    fileElem.appendChild(fileDiv);
    attachment.appendChild(fileElem);
...
function createTask(){
  ...
  if (validationResults == "pass") {
    ...
    document.getElementById('create-task-button').classList.add("animated");
    document.getElementById('create-task-button').classList.add("tada");
